...
import numpy as np
from utils.transform_methods import apply_advanced_motion_blur, add_target_indicator, add_text_annotations 
...
transformations = [
    ...
    ("UI indications", add_text_annotations),    # Apply target indicator alone
...
if __name__ == "__main__":
    ...
    num_images_to_process = 5  # Number of compositions to create and display
    ...
    for i in range(num_images_to_process):
        ...
        #cv2.imwrite(r"D:\mploi\Documents\Albatros\albatros\smoke_generator_V1\scripts\test_transform.png",composed_image_cv2)
